...
class TasksFrame(tk.Frame):
    ...
    def create_task_control_panel(self, parent):
        ...
        self.ctask_label = ttk.Label(frame,textvariable=self.ctask_str,)
        self.ctask_label.pack(fill=tk.X, side=tk.TOP,expand=True,before=self.canvasEntry)
        ...
        x_scroll.pack(fill=tk.X, side=tk.BOTTOM,expand=False,before=self.ctask_label)
        y_scroll.pack(fill=tk.Y, side=tk.RIGHT,before=self.ctask_label)
